<template>
  <div
    class="antialiased max-w-full overflow-hidden bg-green-100 text-16 text-gray-900 text-center"
  >
    <main class="grid">
      <h1 class="sr-only">
        {{ $t('coming_soon.soon') }}
      ...
      <section class="intro bg-green-500 py-72 md:py-132 lg:py-196">
        <div
          class="intro-content container max-w-600 sm:max-w-800 text-white px-60"
        >
      ...
      <!-- Features -->
      <section
        class="container flex flex-col sm:flex-row py-72 md:py-132 lg:py-196 my-72"
      >
        <IllustrationEcommerce
          class="w-full h-350 sm:w-1/2 sm:pr-20 md:pr-36"
        />
