<template>
  <nuxt-link
    ...
    class="inline-block outline-none focus:shadow-outline rounded-lg text-white font-bold text-center uppercase no-underline whitespace-no-wrap transition-colors duration-200 ease-out"
  >
    <font-awesome-icon
      v-if="icon"
      :icon="['far', icon]"
