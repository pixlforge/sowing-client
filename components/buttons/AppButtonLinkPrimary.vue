<template>
  <nuxt-link
    ...
    class="inline-block outline-none focus:shadow-outline rounded-lg text-white font-bold text-center uppercase transition-color transition-faster no-underline"
  >
    <font-awesome-icon
      v-if="icon"
      :icon="['far', icon]"
